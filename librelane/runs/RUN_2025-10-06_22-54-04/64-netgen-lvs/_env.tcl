...
set ::env(NETGEN_SETUP) /foss/pdks/sky130A/libs.tech/netgen/sky130A_setup.tcl
set ::env(LVS_INCLUDE_MARCO_NETLISTS) 0
set ::env(CURRENT_SPICE) /foss/designs/kvic_336007_ws25/librelane/runs/RUN_2025-10-06_22-54-04/62-magic-spiceextraction/tt_um_counter_top.spice
set ::env(CURRENT_POWERED_NETLIST) /foss/designs/kvic_336007_ws25/librelane/runs/RUN_2025-10-06_22-54-04/51-openroad-fillinsertion/tt_um_counter_top.pnl.v
