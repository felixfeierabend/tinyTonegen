set ::env(RSZ_CORNER_0) "nom_tt_025C_1v80 /foss/pdks/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(RSZ_CORNER_1) "nom_ss_100C_1v60 /foss/pdks/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib"
set ::env(RSZ_CORNER_2) "nom_ff_n40C_1v95 /foss/pdks/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib"
...
set ::env(DESIGN_NAME) tt_um_counter_top
...
set ::env(PNR_SDC_FILE) /foss/designs/kvic_336007_ws25/librelane/impl.sdc
...
set ::env(DESIGN_REPAIR_BUFFER_OUTPUT_PORTS) 0
...
set ::env(CURRENT_ODB) /foss/designs/kvic_336007_ws25/librelane/runs/RUN_2025-10-06_22-54-04/27-openroad-globalplacement/tt_um_counter_top.odb
set ::env(SAVE_ODB) /foss/designs/kvic_336007_ws25/librelane/runs/RUN_2025-10-06_22-54-04/31-openroad-repairdesignpostgpl/tt_um_counter_top.odb
set ::env(SAVE_DEF) /foss/designs/kvic_336007_ws25/librelane/runs/RUN_2025-10-06_22-54-04/31-openroad-repairdesignpostgpl/tt_um_counter_top.def
set ::env(SAVE_SDC) /foss/designs/kvic_336007_ws25/librelane/runs/RUN_2025-10-06_22-54-04/31-openroad-repairdesignpostgpl/tt_um_counter_top.sdc
set ::env(SAVE_NETLIST) /foss/designs/kvic_336007_ws25/librelane/runs/RUN_2025-10-06_22-54-04/31-openroad-repairdesignpostgpl/tt_um_counter_top.nl.v
set ::env(SAVE_POWERED_NETLIST) /foss/designs/kvic_336007_ws25/librelane/runs/RUN_2025-10-06_22-54-04/31-openroad-repairdesignpostgpl/tt_um_counter_top.pnl.v
