...
module tt_um_counter_top(ui_in, uo_out, uio_in, uio_out, uio_oe, ena, clk, rst_n);
  input [7:0] ui_in;
  wire [7:0] ui_in;
  output [7:0] uo_out;
  wire [7:0] uo_out;
  ...
  sky130_fd_sc_hd__and3b_2 _22_ (
    .A_N(_10_),
    .B(rst_n),
    .C(_09_),
    .X(_00_)
  );
  sky130_fd_sc_hd__o21ai_2 _23_ (
    .A1(uo_out[4]),
    .A2(_10_),
    .B1(rst_n),
    .Y(_11_)
  ...
  sky130_fd_sc_hd__o21ai_2 _31_ (
    .A1(uo_out[7]),
    .A2(_15_),
    .B1(rst_n),
    .Y(_16_)
  );
  sky130_fd_sc_hd__a21oi_2 _32_ (
    .A1(uo_out[7]),
    .A2(_15_),
    .B1(_16_),
    .Y(_04_)
