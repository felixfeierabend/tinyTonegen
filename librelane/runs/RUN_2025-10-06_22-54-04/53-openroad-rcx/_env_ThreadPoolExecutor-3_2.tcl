...
set ::env(RCX_RULESETS) "\"nom_*\" /foss/pdks/sky130A/libs.tech/openlane/rules.openrcx.sky130A.nom.calibre \"min_*\" /foss/pdks/sky130A/libs.tech/openlane/rules.openrcx.sky130A.min.calibre \"max_*\" /foss/pdks/sky130A/libs.tech/openlane/rules.openrcx.sky130A.max.calibre"
set ::env(CURRENT_DEF) /foss/designs/kvic_336007_ws25/librelane/runs/RUN_2025-10-06_22-54-04/52-odb-cellfrequencytables/tt_um_counter_top.def
set ::env(RCX_LEF) /foss/pdks/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__max.tlef
set ::env(RCX_RULESET) /foss/pdks/sky130A/libs.tech/openlane/rules.openrcx.sky130A.max.calibre
set ::env(SAVE_SPEF) /foss/designs/kvic_336007_ws25/librelane/runs/RUN_2025-10-06_22-54-04/53-openroad-rcx/max/tt_um_counter_top.max.spef
